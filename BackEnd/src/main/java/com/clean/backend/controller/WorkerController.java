...
public class WorkerController {
    ...
    public String insertMyapplication(@RequestParam(name="name")String name,
                                      ...
                                      @RequestParam(name="visitAdministrator")String vititAdministrator){
...
//        return workerService.insertMyapplication(worker,visit,application);
    ...
    public String insertAnswer(@RequestParam(name="name") String name,
